...
export default function AppointmentList() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-md font-medium text-gray-900 mb-4 pb-2 border-b-2 border-[#0ABAB5] w-fit">Appointment Info</h1>
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          <div className="flex bg-gray-100 rounded-md p-1">
            ...
            <Button
              variant="ghost"
              className="rounded-md px-4 py-2 transition-all text-gray-700"
