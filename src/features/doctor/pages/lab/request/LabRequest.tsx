...
export default function LabRequest() {
  ...
  const labData = [
    { id: "10001", name: "Baburao G. Aapte", phone: "9812345678", disease: "Disease", date: "2019/2/14", type: "IPD", time: "1 Hr" ,status: "In Progress"},
    { id: "10001", name: "Baburao G. Aapte", phone: "9812345678", disease: "Disease", date: "2019/2/14", type: "Emergency", time: "1 Hr" ,status: "Completed"},
  ];
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <LabTable data={filteredData} mode="request" />
      </div>
    </div>
  );
}