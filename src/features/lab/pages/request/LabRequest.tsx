...
import ListTable, { type LabItem } from "../../components/list-table";
...
export default function LabsRequest() {
  ...
  return (
    <div className="p-6 ">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Request List</h1>
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <ListTable data={filteredData} mode="request" onPatientClick={setSelectedItem} />
      </div>
      {selectedItem && (
        <EditAction />
      )}
