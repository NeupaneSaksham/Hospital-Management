...
export function AppHeader({ title = "Visits" }: AppHeaderProps) {
  ...
  return (
    ...
    <div className="flex items-center gap-0">
      <Button className="bg-transparent hover:bg-transparent shadow-none cursor-pointer" onClick={() => navigate("/patient")}>
        ...
        <DropdownMenuTrigger asChild>
          <div className="flex items-center gap-2 h-8 px-3 text-xs sm:text-sm cursor-pointer">
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline font-bold text-[#9A9AA9]">Patient</span>
